document.addEventListener('DOMContentLoaded', () => {
    ...
    // Ensure we point to the correct Backend port (9090) during development
    const isLocal = window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1';
    const API_BASE = (isLocal && window.location.port !== '9090') ? 'http://localhost:9090' : window.location.origin;
